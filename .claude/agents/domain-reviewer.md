...
<!-- ============================================================
     ...
     pedagogy-reviewer). This agent is your "top-journal referee" equivalent.
     ...
     Examples of Lens 4 customization:
     - Econometrics: identification assumptions, SE computation, estimator choice
     - Biology: lab protocol validity, statistical power, control conditions
     - Machine learning: train/test leakage, metric choice, hyperparameter tuning
     ============================================================ -->
