...
| **Clarity & Pedagogy** | 15% | Every formula has both derivation and intuitive interpretation. Jargon defined inline on first use (propensity, HHI, KL, Bellman, etc.). Limiting cases discussed (e.g., β=0 collapses dynamic to myopic). Concrete example for abstract concepts. Readable without the original paper. | Most formulas interpreted; one or two left as bare equations. Most jargon defined; one term used cold. | Formulas dropped without interpretation. Jargon assumed throughout. Reader needs the original paper to follow. |
...
- LaTeX files inside named-paper folders
