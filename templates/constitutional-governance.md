...
**Example (multi-language):** Language-specific subdirectories (`python/`); no mixed-language files.

**Example (literate programming):** All code lives in `.ipynb` files; extracted `.py` scripts are derived artifacts.
